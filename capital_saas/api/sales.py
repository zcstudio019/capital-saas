...
from db.models import FollowTask, Lead, Order, User
...
def workbench(
    ...
    if not scope.can_view_all:paid_query=paid_query.filter(Order.owner_org_id.in_(scope.allowed_org_ids or [-1]))
