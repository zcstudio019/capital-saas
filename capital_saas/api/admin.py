...
def update_settings(
    ...
    capital_health_report_price: str = Form("980"),
    capital_structure_plan_price: str = Form("1999"),
    one_on_one_consulting_price: str = Form("9800"),
    capital_health_institution: str = Form("沪上银 · 企业资本健康管理中心"),
    capital_health_report_validity_days: str = Form("90"),
    capital_health_show_english_subtitle: str = Form("true"),
    structure_plan_upgrade_mode: str = Form("deduct_report_price"),
    ...
    save_settings(db, {
        ...
        "capital_health_report_price": capital_health_report_price,
        "capital_structure_plan_price": capital_structure_plan_price,
        "one_on_one_consulting_price": one_on_one_consulting_price,
        "capital_health_institution": capital_health_institution,
        "capital_health_report_validity_days": capital_health_report_validity_days,
