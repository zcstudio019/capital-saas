...
SETTING_DEFINITIONS = {
    ...
    "product_free_assessment_is_public": ("true", "免费测评是否公开展示"),
    "product_free_assessment_is_active": ("true", "免费测评是否启用"),
    "product_free_assessment_type": ("free_entry", "免费测评产品类型"),
    "product_980_capital_health_report_is_public": ("true", "980元体检报告是否公开展示"),
    "product_980_capital_health_report_is_active": ("true", "980元体检报告是否启用"),
    "product_980_capital_health_report_type": ("core_report", "980元体检报告产品类型"),
    "product_299_report_is_public": ("false", "299元简版报告是否公开展示"),
    "product_299_report_is_active": ("true", "299元简版报告是否启用"),
    "product_299_report_type": ("hidden_offer", "299元简版报告产品类型"),
    "product_699_bank_match_is_public": ("false", "699元专项匹配报告是否公开展示"),
    "product_699_bank_match_is_active": ("true", "699元专项匹配报告是否启用"),
    "product_699_bank_match_type": ("specialist_offer", "699元专项匹配报告产品类型"),
    "product_1999_structure_plan_is_public": ("true", "1999元优化方案是否公开展示"),
    "product_1999_structure_plan_is_active": ("true", "1999元优化方案是否启用"),
    "product_1999_structure_plan_type": ("structure_plan", "1999元优化方案产品类型"),
    "product_one_on_one_consulting_is_public": ("true", "1对1顾问服务是否公开展示"),
    "product_one_on_one_consulting_is_active": ("true", "1对1顾问服务是否启用"),
    "product_one_on_one_consulting_type": ("advisor_service", "1对1顾问服务产品类型"),
