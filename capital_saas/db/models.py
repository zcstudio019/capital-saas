...
class Assessment(Base):
    ...
    collateral_types: Mapped[str] = mapped_column(Text, default="")
    tax_status: Mapped[bool] = mapped_column(Boolean)
    credit_status: Mapped[bool] = mapped_column(Boolean)
    enterprise_credit_status: Mapped[str] = mapped_column(String(30), default="unknown")
    legal_credit_status: Mapped[str] = mapped_column(String(30), default="unknown")
    credit_query_count_6m: Mapped[int] = mapped_column(Integer, default=0)
    credit_card_usage_rate: Mapped[float | None] = mapped_column(Float, nullable=True)
    lender_count: Mapped[int] = mapped_column(Integer, default=0)
    online_loan_status: Mapped[str] = mapped_column(String(30), default="unknown")
    public_inflow_monthly: Mapped[float] = mapped_column(Float, default=0)
    public_outflow_monthly: Mapped[float] = mapped_column(Float, default=0)
    operating_flow_ratio: Mapped[float | None] = mapped_column(Float, nullable=True)
    public_private_ratio: Mapped[float | None] = mapped_column(Float, nullable=True)
    internal_transfer_ratio: Mapped[float | None] = mapped_column(Float, nullable=True)
    fast_in_out_status: Mapped[str] = mapped_column(String(30), default="unknown")
    tax_credit_grade: Mapped[str] = mapped_column(String(10), default="unknown")
    tax_paid_12m: Mapped[float] = mapped_column(Float, default=0)
    invoiced_revenue_12m: Mapped[float] = mapped_column(Float, default=0)
    tax_arrears_status: Mapped[str] = mapped_column(String(30), default="unknown")
    revenue_growth_rate: Mapped[float | None] = mapped_column(Float, nullable=True)
    enforcement_status: Mapped[str] = mapped_column(String(30), default="unknown")
    dishonest_status: Mapped[str] = mapped_column(String(30), default="unknown")
    consumption_restriction_status: Mapped[str] = mapped_column(String(30), default="unknown")
    lawsuit_plaintiff_status: Mapped[str] = mapped_column(String(30), default="unknown")
    lawsuit_defendant_status: Mapped[str] = mapped_column(String(30), default="unknown")
    admin_penalty_status: Mapped[str] = mapped_column(String(30), default="unknown")
    property_value: Mapped[float] = mapped_column(Float, default=0)
    factory_value: Mapped[float] = mapped_column(Float, default=0)
    land_value: Mapped[float] = mapped_column(Float, default=0)
    vehicle_value: Mapped[float] = mapped_column(Float, default=0)
    equipment_value: Mapped[float] = mapped_column(Float, default=0)
    financeable_receivables: Mapped[float] = mapped_column(Float, default=0)
    inventory_value: Mapped[float] = mapped_column(Float, default=0)
    external_investment_value: Mapped[float] = mapped_column(Float, default=0)
    intellectual_property_types: Mapped[str] = mapped_column(Text, default="")
...
class CustomerAccount(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    lead_id: Mapped[int | None] = mapped_column(ForeignKey("leads.id"), nullable=True, unique=True, index=True)
    assessment_id: Mapped[int | None] = mapped_column(ForeignKey("assessments.id"), nullable=True, index=True)
    company_name: Mapped[str] = mapped_column(String(200), default="")
    ...
    registration_method: Mapped[str] = mapped_column(String(20), default="password")
    registration_source: Mapped[str] = mapped_column(String(40), default="historical_data", index=True)
    is_active: Mapped[bool] = mapped_column(Boolean, default=True, index=True)
    failed_login_count: Mapped[int] = mapped_column(Integer, default=0)
    locked_until: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    last_login_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
